...
TEAM = 2073  # Place your Team number here

os.chdir('C:/EagleScout')  # (' ./EagleScout) # Set for your system

# ------------------------------- Perform file Clean up -------------------------------

# Remove the combined .csv file and all spreadsheets from previous runs
# This will provide clean data without corruption from earlier runs
...
with pd.ExcelWriter('./Spreadsheets/Combined.xlsx',
...
#  USING OPENPYXL
ScrCont = openpyxl.load_workbook('./Spreadsheets/Combined.xlsx', read_only=False,
...
with pd.ExcelWriter('./Spreadsheets/Master.xlsx') as writer:
    df2 = pd.read_excel('./Spreadsheets/ScoreContrib.xlsx',
